 ...
 */
class UstencilTest extends UnitTestCase
{
    /**
     * @var \Arpr\RecipeArpr\Domain\Model\Ustencil|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = $this->getAccessibleMock(
            \Arpr\RecipeArpr\Domain\Model\Ustencil::class,
            ['dummy']
        );
    }
